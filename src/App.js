      ...
      <AnimatePresence>
        {isVisible && (
          <div className="fixed bottom-8 right-20">
            <motion.button
              onClick={scrollToTop}
              className="bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 z-50 animate-bounce"
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
      ...
      <div className="container mx-auto px-4 pt-4 max-w-4xl text-gray-100">
        ...
        >
          <div className="flex flex-row items-center mb-4">
            <img
              src="https://media.licdn.com/dms/image/v2/D4E35AQE0KozTt4xDkw/profile-framedphoto-shrink_200_200/profile-framedphoto-shrink_200_200/0/1731838603702?e=1732449600&v=beta&t=mBUv7XvQ8_v9ul51djmlM6iz6UzqzH4zkUul58DFol0"
              alt="profile"
              className="w-24 h-24 rounded-3xl object-cover shadow-lg md:w-32 md:h-32"
            />

            <h1 className="text-4xl font-bold ml-4 leading-[50px] text-gray-100 font-mono">
              Park ChoRong <br />
              박초롱
            </h1>
          </div>
        ...
        <div className="mt-4 pl-4">
          ...
          <Section title="💼 Employment" id="경력">
            <div className="text-[18px] font-semibold text-gray-100 pt-4">
          ...
          <Section title="💞️ Project" id="프로젝트">
          ...
          <Section title="📫 How to reach me" id="연락처">
            ...
            <div className="flex flex-col space-y-4 pb-4">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 p-3 bg-gradient-to-r from-blue-900 rounded-lg hover:bg-gradient-to-r hover:from-blue-800 transition-colors duration-300"
              >
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 p-3 bg-gradient-to-r from-gray-800 rounded-lg hover:bg-gradient-to-r hover:from-gray-700 transition-colors duration-300"
              >
